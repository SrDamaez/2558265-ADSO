...
public class Info_vendedor extends javax.swing.JFrame {
    
    private String cedula;
    DataBase basedatos;
    
    public Info_vendedor( DataBase basedatos, String cedula) {
        this.cedula = cedula;
        ...
        try {
            ...
            Logger.getLogger(Info_vendedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        campo_rol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vendedor", "Usuario" }));
